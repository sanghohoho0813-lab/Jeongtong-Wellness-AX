 ...
 * 전에는 이랬다.
 *
 *   공개 Front 머리글 아래  "매장 직원이신가요?  내부 AX 화면 ›"   (밑줄 링크)
 ...
 *
 * 게다가 공개 Front 의 그 줄은 **모든 고객에게** 늘 보였다. 이 화면을
 ...
 * 지금 서 있는 쪽.
 *
 * "public" 은 공개 Front(/welcome) — 두 쪽 어디도 아니다. 그래서 그때는
 * 어느 칸도 눌린 상태로 그리지 않는다. 공개 화면에 서서 '고객 화면'이
...
const SIDE = {
  ...
  portal: { href: "/my", label: "고객 화면", icon: UsersIcon },
} as const;
