...
| **폰 최적화 — 첫 일거리가 첫 화면 안에 · 설정 접이식** | **LIVE** | 설정 10.6 → 2.3화면. 폰만 접고 PC 는 그대로 편다 |
| **가장 좁은 폰(360) + 가장 큰 글씨** | **LIVE** | 60대가 실제로 쓰는 설정. 23개 화면에서 옆으로 새는 곳 · 잘린 글자 0. `qa/mobile.mjs` 58건이 지킨다 |
...
- 단위 테스트 220 · QA 회귀 20묶음 · 테마 대비 33/33 · CI 자동 실행
...
| `DECISIONS.md` | 결정 33건 — WHY · WHY NOT · REVISIT WHEN |
